...
printf "\nAlice's balance: "
curl --request GET \
  --url http://localhost:7870/accounts/alice/balance \
  --header 'Accept: application/json' \
  --header 'Authorization: Bearer hi_bob'
printf "\nCharlie's balance: "
curl --request GET \
  --url http://localhost:7870/accounts/charlie/balance \
  --header 'Accept: application/json' \
  --header 'Authorization: Bearer hi_bob'
...
printf "\nBob's balance: "
curl --request GET \
  --url http://localhost:7970/accounts/bob/balance \
  --header 'Accept: application/json' \
  --header 'Authorization: Bearer hi_charlie'
printf "\nCharlie's balance: "
curl --request GET \
  --url http://localhost:7970/accounts/charlie/balance \
  --header 'Accept: application/json' \
  --header 'Authorization: Bearer hi_charlie'
